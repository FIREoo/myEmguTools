...
namespace myEmguLibrary
{
    public static class MyInvoke
    {
                ...
                if (mat.NumberOfChannels == 1)
                    switch (Type.GetTypeCode(typeof(T)))
                    {
                        ...
                        case TypeCode.UInt16:
                            UInt16* pixelPtr_uint = (UInt16*)mat.DataPointer;
                            return (T)Convert.ChangeType(pixelPtr_uint[row * mat.Cols + col], typeof(T));
        ...
        public static bool inRect(Rectangle rect, Point P)
        {
